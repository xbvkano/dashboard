...
const scheduleTranslations = {
  en: {
    ...
    navJobs: 'Jobs',
    navSignOut: 'Sign Out',
    navSignOutConfirm: 'Are you sure you want to sign out?',
    confirmJobConfirm: 'Are you sure you want to confirm this job?',
    confirmJobModalTitle: 'Confirm job',
    confirmJobConfirmButton: 'Confirm',
  ...
  pt: {
    ...
    navJobs: 'Trabalhos',
    navSignOut: 'Sair',
    navSignOutConfirm: 'Tem certeza que deseja sair?',
    confirmJobConfirm: 'Tem certeza que deseja confirmar este trabalho?',
    confirmJobModalTitle: 'Confirmar trabalho',
    confirmJobConfirmButton: 'Confirmar',
  ...
  es: {
    ...
    navSignOutConfirm: '¿Estás seguro de que quieres cerrar sesión?',
    confirmJobConfirm: '¿Estás seguro de que quieres confirmar este trabajo?',
    confirmJobModalTitle: 'Confirmar trabajo',
    confirmJobConfirmButton: 'Confirmar',
